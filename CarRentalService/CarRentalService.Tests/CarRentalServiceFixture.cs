...
public class CarRentalServiceFixture
{
    ...
    [
        new () { Id = 0, Name = "Прокат в центре", Address = "ул. Ленина, д. 123" },
        new () { Id = 1, Name = "Прокат в аэропорту", Address = "ул. Воздушная, д. 456" },
        new () { Id = 2, Name = "Прокат в пригороде", Address = "ул. Зеленая, д. 789" }
    ];

    public List<Vehicle> Vehicles =
    [
        new () { Id = 0, Model = "Тойота Королла", Color = "Белый" },
        new () { Id = 1, Model = "Хонда Цивик", Color = "Черный" },
        new () { Id = 2, Model = "Форд Фокус", Color = "Синий" },
        new () { Id = 3, Model = "Тойота Королла", Color = "Красный" },
